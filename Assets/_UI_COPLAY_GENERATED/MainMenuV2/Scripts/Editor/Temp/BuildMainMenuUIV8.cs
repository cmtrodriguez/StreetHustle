...
public class BuildMainMenuUIV8
{
    ...
    static void CreateButton(Transform parent, string name, string mainText, string subText, Vector2 pos, Vector2 size, Sprite sprite)
    {
        ...
        mainTextRect.sizeDelta = new Vector2(0, 0);
        mainTextRect.anchoredPosition = new Vector2(0, -10); // Shifted down slightly
        ...
        subTextRect.sizeDelta = new Vector2(0, 0);
        subTextRect.anchoredPosition = new Vector2(0, 10); // Shifted up slightly
    }
}