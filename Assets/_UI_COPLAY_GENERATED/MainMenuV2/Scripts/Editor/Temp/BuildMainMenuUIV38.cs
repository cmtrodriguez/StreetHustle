...
public class BuildMainMenuUIV38
{
    ...
    static void CreateButton(Transform parent, string name, string mainText, string subText, Vector2 pos, Vector2 size, Sprite bgSprite, Sprite iconSprite)
    {
        ...
        if (iconSprite != null)
        {
            ...
            iconRect.anchoredPosition = new Vector2(60, 0); // Positioned relative to container
        }
        ...
        mainTextRect.anchoredPosition = new Vector2(120, 10); // Moved closer to icon
        ...
        subTextRect.anchoredPosition = new Vector2(120, -15); // Moved closer to icon
    }
}