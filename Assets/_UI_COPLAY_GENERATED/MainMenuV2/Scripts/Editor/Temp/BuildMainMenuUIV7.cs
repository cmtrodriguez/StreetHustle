...
public class BuildMainMenuUIV7
{
    ...
    static void CreateButton(Transform parent, string name, string mainText, string subText, Vector2 pos, Vector2 size, Sprite sprite)
    {
        ...
        mainTextRect.anchoredPosition = new Vector2(0, -5); // Shifted down slightly
        ...
        subTextRect.anchoredPosition = new Vector2(0, 5); // Shifted up slightly
    }
}