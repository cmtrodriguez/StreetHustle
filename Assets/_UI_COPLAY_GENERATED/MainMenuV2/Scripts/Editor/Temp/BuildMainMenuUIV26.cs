...
public class BuildMainMenuUIV26
{
    ...
    static void CreateButton(Transform parent, string name, string mainText, string subText, Vector2 pos, Vector2 size, Sprite bgSprite, Sprite iconSprite)
    {
        ...
        if (iconSprite != null)
        {
            ...
            iconRect.anchoredPosition = new Vector2(100, 0); // Moved further right
        }
        ...
        mainTextRect.anchoredPosition = new Vector2(160, 10); // Moved further right, closer to icon
        ...
        subTextRect.anchoredPosition = new Vector2(160, -15); // Moved further right, closer to icon
    }
}