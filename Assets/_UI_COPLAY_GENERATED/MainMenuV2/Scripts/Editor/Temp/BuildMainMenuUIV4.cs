...
public class BuildMainMenuUIV4
{
    public static void Execute()
    {
        ...
        // Buttons
        CreateButton(canvasGO.transform, "StartWeekButton", "START WEEK", "Begin your 6-day hustle", new Vector2(-380, -30), new Vector2(400, 80), startBtnSprite);
        CreateButton(canvasGO.transform, "InstructionsButton", "INSTRUCTIONS", "How to play", new Vector2(-380, -120), new Vector2(400, 80), normalBtnSprite);
        CreateButton(canvasGO.transform, "SettingsButton", "SETTINGS", "Audio, Video, Controls", new Vector2(-380, -210), new Vector2(400, 80), normalBtnSprite);
        CreateButton(canvasGO.transform, "ExitButton", "EXIT", "Quit Game", new Vector2(-380, -300), new Vector2(400, 80), normalBtnSprite);
    }
    ...
    static void CreateButton(Transform parent, string name, string mainText, string subText, Vector2 pos, Vector2 size, Sprite sprite)
    {
        ...
        mainTextRect.anchoredPosition = new Vector2(80, 0); // Offset from left to leave room for icons
        ...
        subTextRect.anchoredPosition = new Vector2(80, 0); // Offset from left
    }
}