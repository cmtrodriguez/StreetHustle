...
public class BuildMainMenuUIV20
{
    ...
    static void CreateButton(Transform parent, string name, string mainText, string subText, Vector2 pos, Vector2 size, Sprite bgSprite, Sprite iconSprite)
    {
        ...
        mainTextRect.anchoredPosition = new Vector2(50, 10); // Shifted right to make room for icon, and up slightly
        ...
        subTextRect.anchoredPosition = new Vector2(50, -15); // Shifted right to make room for icon, and down slightly
    }
}