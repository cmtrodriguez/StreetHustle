...
public class BuildMainMenuUIV29
{
    ...
    static void CreateButton(Transform parent, string name, string mainText, string subText, Vector2 pos, Vector2 size, Sprite bgSprite, Sprite iconSprite)
    {
        ...
        containerRect.sizeDelta = new Vector2(220, 60); // Even tighter container
        ...
        mainTextRect.anchoredPosition = new Vector2(70, 10); // Moved closer to icon
        ...
        subTextRect.anchoredPosition = new Vector2(70, -15); // Moved closer to icon
    }
}