...
public class BuildMainMenuUIV9
{
    ...
    static void CreateButton(Transform parent, string name, string mainText, string subText, Vector2 pos, Vector2 size, Sprite bgSprite, Sprite iconSprite)
    {
        ...
        mainTextRect.anchoredPosition = new Vector2(90, -5); // Shifted right to make room for icon, and down slightly
        ...
        subTextRect.anchoredPosition = new Vector2(90, 5); // Shifted right to make room for icon, and up slightly
    }
}