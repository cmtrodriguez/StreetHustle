...
public class BuildMainMenuUIV27
{
    ...
    static void CreateButton(Transform parent, string name, string mainText, string subText, Vector2 pos, Vector2 size, Sprite bgSprite, Sprite iconSprite)
    {
        ...
        containerRect.sizeDelta = new Vector2(300, 60); // Approximate size of content
        ...
        if (iconSprite != null)
        {
            ...
            iconRect.anchoredPosition = new Vector2(20, 0); // Positioned relative to container
        }
        ...
        mainTextRect.sizeDelta = new Vector2(-60, 30); // Padding for icon
        mainTextRect.anchoredPosition = new Vector2(80, 10); // Positioned relative to container
        ...
        subTextRect.sizeDelta = new Vector2(-60, 30); // Padding for icon
        subTextRect.anchoredPosition = new Vector2(80, -15); // Positioned relative to container
    }
}